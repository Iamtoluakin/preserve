-- COMPLETE CLEANUP INCLUDING AUTH USERS
-- Run this entire script in Supabase SQL Editor

-- ============================================
-- STEP 1: Clean up auth.users FIRST
-- ============================================

-- This will cascade and delete related records
DELETE FROM auth.users;

SELECT 'Auth users cleaned up!' as status;

-- ============================================
-- STEP 2: Clean up remaining data
-- ============================================

-- Delete from dependent tables (just to be safe)
...
SELECT 'Setup complete! Everything is clean!' as final_status;
