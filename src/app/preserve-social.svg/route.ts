const socialSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" role="img" aria-label="PreserveHQ property care and preservation operations">
  ...
  <text x="92" y="310" fill="#0f172a" font-family="Arial, sans-serif" font-size="76" font-weight="900">
    <tspan x="92" dy="0">Property care.</tspan>
    <tspan x="92" dy="78">Handled.</tspan>
  </text>
  <text x="92" y="500" fill="#475569" font-family="Arial, sans-serif" font-size="24" font-weight="500">
    <tspan x="92" dy="0">From one home to an entire portfolio,</tspan>
    <tspan x="92" dy="32">PreserveHQ coordinates trusted local pros.</tspan>
  </text>
  ...
  <rect x="694" y="468" width="334" height="58" rx="24" fill="#ffffff" opacity="0.94"/>
  ...
  <text x="758" y="505" fill="#0f172a" font-family="Arial, sans-serif" font-size="22" font-weight="800">Property work coordinated</text>
</svg>`;
